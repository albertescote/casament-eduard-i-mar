  ...
  return (
    <section className="relative min-h-screen">
      ...
      <div className="relative w-full">
        ...
        <div className="mt-8 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-24">
          {/* Venue Section */}
          <motion.section
            initial="hidden"
            whileInView="visible"
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center justify-between p-4 bg-gradient-to-br from-[#898651]/10 to-[#898651]/5 rounded-2xl border-2 border-[#898651]/30 shadow-sm">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      <motion.li
                        ...
                        className="flex items-start gap-3 p-4 bg-gradient-to-br from-[#898651]/10 to-[#898651]/5 rounded-2xl border-2 border-[#898651]/30 shadow-sm"
                      >
                        <svg
                          className="w-5 h-5 mt-0.5 flex-shrink-0 text-[#898651]"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                          <path
